...
public class AmazonFreeRTOSOldManager: NSObject {
    ...
    public var advertisingServiceUUIDs: [CBUUID] = [AmazonFreeRTOSOldGattService.DeviceInfo]
    /// Service UUIDs.
    public var serviceUUIDs: [CBUUID] = [AmazonFreeRTOSOldGattService.DeviceInfo, AmazonFreeRTOSOldGattService.NetworkConfig]

    /// Shared instence of Amazon FreeRTOS Manager.
    public static let shared = AmazonFreeRTOSOldManager()
...
extension AmazonFreeRTOSOldManager {
    ...
    public func getAfrVersionOfPeripheral(_ peripheral: CBPeripheral) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.DeviceInfo)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.AfrVersion) else {
    ...
    public func getBrokerEndpointOfPeripheral(_ peripheral: CBPeripheral) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.DeviceInfo)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.BrokerEndpoint) else {
    ...
    public func getMtuOfPeripheral(_ peripheral: CBPeripheral) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.DeviceInfo)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.Mtu) else {
    ...
    public func listNetworkOfPeripheral(_ peripheral: CBPeripheral, listNetworkReq: ListNetworkReq) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.NetworkConfig)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.ListNetwork) else {
    ...
    public func saveNetworkToPeripheral(_ peripheral: CBPeripheral, saveNetworkReq: SaveNetworkReq) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.NetworkConfig)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.SaveNetwork) else {
    ...
    public func editNetworkOfPeripheral(_ peripheral: CBPeripheral, editNetworkReq: EditNetworkReq) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.NetworkConfig)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.EditNetwork) else {
    ...
    public func deleteNetworkFromPeripheral(_ peripheral: CBPeripheral, deleteNetworkReq: DeleteNetworkReq) {
        ...
        guard let characteristic = peripheral.serviceOf(uuid: AmazonFreeRTOSOldGattService.NetworkConfig)?.characteristicOf(uuid: AmazonFreeRTOSOldGattCharacteristic.DeleteNetwork) else {
...
extension AmazonFreeRTOSOldManager: CBCentralManagerDelegate {
...
extension AmazonFreeRTOSOldManager: CBPeripheralDelegate {
